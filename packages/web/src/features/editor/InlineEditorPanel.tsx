...
export function InlineEditorPanel({ noteId, onClose }: InlineEditorPanelProps) {
  ...
  if (loading) {
    return (
      <div className="hidden xl:flex flex-col items-center justify-center w-[50%] border-l border-border-default px-6 py-6">
  ...
  return (
    <div className="hidden xl:flex flex-col w-[50%] border-l border-border-default px-6 py-6">
      {/* Header */}
